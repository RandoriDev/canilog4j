...
draft: 'false'
name: Capture Security Appliance
title: SonicWall Capture Security Appliance
vendor: SonicWall
---
...
| Source | Note |
| --- | --- |
| [CISAGov](https://raw.githubusercontent.com/cisagov/log4j-affected-db/develop/README.md) | Log4j2 not used in the Capture Security appliance. |

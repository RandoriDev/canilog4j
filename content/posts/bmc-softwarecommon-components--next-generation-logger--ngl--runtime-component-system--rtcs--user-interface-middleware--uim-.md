...
draft: 'false'
name: 'Common Components: Next Generation Logger (NGL), Runtime Component System (RTCS),
  User Interface Middleware (UIM)'
title: 'BMC Software Common Components: Next Generation Logger (NGL), Runtime Component
  System (RTCS), User Interface Middleware (UIM)'
vendor: BMC Software
---

...
draft: 'false'
name: CENTUM VP (other components)
title: Yokogawa CENTUM VP (other components)
vendor: Yokogawa
---
...
| [NCSC-NL](https://github.com/NCSC-NL/log4shell/blob/main/software/README.md) | Unified Gateway Station (UGS2) Standard Function R6.06.00 or earlier is still under investigation |

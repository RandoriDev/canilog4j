...
| [NCSC-NL](https://github.com/NCSC-NL/log4shell/blob/main/software/README.md) | Completed patching for the Apache Log4j2 issue (CVE-2021-44228). Vulnerable only if customer's applications use affected versions of Apache Log4j |

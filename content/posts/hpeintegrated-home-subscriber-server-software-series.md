...
draft: 'false'
name: Integrated Home Subscriber Server Software Series
title: HPE Integrated Home Subscriber Server Software Series
vendor: HPE
---
...
| [NCSC-NL](https://github.com/NCSC-NL/log4shell/blob/main/software/README.md) | Only vulnerable when using the nHSS 4G/5G IWK function |

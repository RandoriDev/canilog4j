...
| [NCSC-NL](https://github.com/NCSC-NL/log4shell/blob/main/software/README.md) | 10/19 release distribution does not include Log4j. Vulnerable only if customer's applications use affected versions of Apache Log4j |
